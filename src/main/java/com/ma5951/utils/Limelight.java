...
public class Limelight {
    public static double K_DELTA_Y = 0; // TODO
    private static double K_LIMELIGHT_STATIC_ANGLE = 0; // TODO
    ...
    public static double distance() {
        double limelightAngle = y + K_LIMELIGHT_STATIC_ANGLE;
        return Math.tan(limelightAngle) / K_DELTA_Y;
    }
