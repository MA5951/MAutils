...
import com.ma5951.utils.controllers.interfaces.BasePIDController;
...
public class PIDController implements BasePIDController {
     ...
     */
    public PIDController(double KP, double KI, double KD, double KF, double tolerance, double low, double high) {
        this.KP = KP;
        this.KI = KI;
        this.KD = KD;
        this.KF = KF;
        ...
        pidController = new edu.wpi.first.math.controller.PIDController(this.KP, this.KI, this.KD);
